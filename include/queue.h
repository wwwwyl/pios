...
// 需要修改elm的prev节点，例如删除elm或在elm前面插入
// 如果le_prev是1级指针：  (elm)->field.le_prev->field.le_next = ...
// 如果le_prev是2级指针：*((elm)->field.le_prev) = ...
// 同样的，需要修改elm的next
// 如果le_next是1级指针：  (elm)->field.le_next->field.le_prev = ...
// 如果le_next是2级指针：*((elm)->field.le_next) = ...
